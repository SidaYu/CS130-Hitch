...
import { Animated, View, TouchableOpacity, Text, DatePickerIOS, TextInput, St } from 'react-native';
...
class CollapsibleDatePickerIOS extends React.Component {
  ...
  render() {
    ...
    var textboxStyle = locals.stylesheet.textbox.normal;
